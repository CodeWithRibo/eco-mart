...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 shadow-md fixed left-0 right-0  z-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        @endphp
            ...
            <a href="{{route('shopping-carts')}}" class="pr-5 absolute right-[7.5rem]  bottom-6 z-50">
                <x-ui.icon name="ps:shopping-cart" class="size-5 fill-gray-700 "/>
            </a>
            {{--Cart Items--}}
            <div class="pr-5 absolute right-[6.5rem]  bottom-10 z-50">
                <span class="rounded-full bg-[#F9C74F] px-2 py-1 text-xs">{{$count}}</span>
            </div>

            <!-- Settings Dropdown -->
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger" class="space-x-3">
                        <button
